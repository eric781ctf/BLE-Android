...
public class DeviceDetailActivity extends AppCompatActivity {
    ...
    private void appendAdRecordView(final MergeAdapter adapter, final String title, final AdRecord record) {
        ...
        final TextView tvString = lt.findViewById(R.id.data_as_string);
        final TextView tvArray = lt.findViewById(R.id.data_as_array);
        final TextView tvTitle = lt.findViewById(R.id.title);
    ...
    private void appendDeviceInfo(final MergeAdapter adapter, final BluetoothLeDevice device) {
        ...
        final TextView tvName = lt.findViewById(R.id.deviceName);
        final TextView tvAddress = lt.findViewById(R.id.deviceAddress);
        final TextView tvClass = lt.findViewById(R.id.deviceClass);
        final TextView tvMajorClass = lt.findViewById(R.id.deviceMajorClass);
        final TextView tvServices = lt.findViewById(R.id.deviceServiceList);
        final TextView tvBondingState = lt.findViewById(R.id.deviceBondingState);
    ...
    private void appendSimpleText(final MergeAdapter adapter, final String data) {
        ...
        final TextView tvData = lt.findViewById(R.id.data);
