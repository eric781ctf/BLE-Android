...
public class ToastUtil {
    ...
    public enum CommonToastType {
        TOAST_TYPE_NORMAL, // 普通toast-笑臉
        TOAST_TYPE_SUC, // 成功toast-笑臉
        TOAST_TYPE_ACC, // 加速toast-笑臉
        TOAST_TYPE_SMILE, // 微笑toast-笑臉
        TOAST_TYPE_ALARM// 失敗or警告toast-哭臉
    }
    ...
    public static synchronized void showToast(Context context, CommonToastType type, String str) {
        try {
            ...
            if (str != null
                ...
                mBasicToast.setDuration(Toast.LENGTH_SHORT);// 默認只顯示2秒
                mBasicToast.show();
            }
        } catch (Exception e) {
            e.printStackTrace();
